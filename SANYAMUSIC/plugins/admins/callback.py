        ...
        try:
            ...
            if playing:
                ...
                if duration_seconds > 0:
                    ...
                    buttons = stream_markup(_, chat_id, autoplay_on=ap_on)
                await CallbackQuery.message.edit_reply_markup(
                    reply_markup=InlineKeyboardMarkup(buttons)
                )
        except:
            pass
        # Notification message — 5 sec baad delete
        msg = await CallbackQuery.message.reply_text(status_text)
